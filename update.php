  ...
  <form method="post" name="updateform" id="updateform">
    ...
    <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" class="komentar">
      ...
      <tr>
        ...
        <td width="71%" valign="top"><input name="tnama" type="text" id="tnama" size="50" maxlength="100" value="<?= $nama; ?>"></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td align="center" valign="top">:</td>
        <td valign="top">
          <textarea name="tkomentar" cols="60" rows="15" id="tkomentar"><?= $komentar; ?></textarea>
        </td>
      </tr>
      <tr>
        <td colspan="3" align="left" valign="top">
          <input name="btnUpdate" type="submit" class="box" id="btnUpdate" value="Update">
        </td>
      </tr>
    </table>
  </form>
