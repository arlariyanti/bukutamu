...
if (empty($_SESSION['sadmin_username'])) {
    // Handle the case when the session is not set (redirect or other action)
}
...
// if $_GET['page'] is defined, use it as a page number
if (isset($_GET['page'])) {
    $pageNum = $_GET['page'];
}
...
?>
<p><h2 align="center">Daftar Bukutamu</h2></p>
<table align="center">
    <tr>
